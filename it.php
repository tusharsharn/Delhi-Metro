...
include 'partials/connect_it.php';
...
if( $exists==false){
    $sql="INSERT INTO `it1` (`name`, `qual`, `gender`, `dob`, `mobile`, `resume`, `address`, `email`) VALUES ('$name', '$qual', '$gender', '$dob', '$mobile', '$resume', '$address', '$email')";;
...
?>
   <div class="container">
    <h1 class="text-center">Register for information technology</h1>
   <form action="/loginsystem/it.php" method="post">
  <div class="mb-3">
