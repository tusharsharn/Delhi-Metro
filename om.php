...
include 'partials/connect_om.php';
...
if( $exists==false){
    $sql="INSERT INTO `om1` (`name`, `qual`, `gender`, `dob`, `mobile`, `resume`, `address`, `email`) VALUES ('$name', '$qual', '$gender', '$dob', '$mobile', '$resume', '$address', '$email')";;
...
?>
   <div class="container">
    <h1 class="text-center">Register for operation management</h1>
   <form action="/loginsystem/om.php" method="post">
  <div class="mb-3">
