...
include 'partials/connect_hr.php';
...
if( $exists==false){
    $sql="INSERT INTO `hr1` (`name`, `qual`, `gender`, `dob`, `mobile`, `resume`, `address`, `email`) VALUES ('$name', '$qual', '$gender', '$dob', '$mobile', '$resume', '$address', '$email')";;
...
?>
   <div class="container">
    <h1 class="text-center">Register for Human resources</h1>
   <form action="/loginsystem/hr.php" method="post">
  <div class="mb-3">
