...
include 'partials/connect_finance.php';
...
if( $exists==false){
    $sql="INSERT INTO `finance1` (`name`, `qual`, `gender`, `dob`, `mobile`, `resume`, `address`, `email`) VALUES ('$name', '$qual', '$gender', '$dob', '$mobile', '$resume', '$address', '$email')";
...
?>
   <div class="container">
    <h1 class="text-center">Register for finance</h1>
   <form action="/loginsystem/finance.php" method="post">
  <div class="mb-3">
  ...
  <div class="mb-3">
    <label for="qual"  class="form-label">Educational Qualifications</label>
...
<div class="mb-3">
    ...
    <input type="text" class="form-control" id="resume" name="resume" placeholder="upload google drive link of your resume" aria-describedby="emailHelp">
